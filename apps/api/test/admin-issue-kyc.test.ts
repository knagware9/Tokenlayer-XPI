 ...
 * itself is never gated. Every asset now starts `pending_approval` with its
 * mint + sale terms deferred; complete due diligence via the shared helper so
 * this test still gets back an already-active, priced asset. */
