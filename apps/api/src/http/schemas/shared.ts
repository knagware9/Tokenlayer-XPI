...
export const sharedSchemas: Record<string, FastifySchema> = {
        ...
        properties: {
          ...
          user: {
            ...
            properties: {
              ...
              kycExpiresAt: { type: "string", nullable: true, description: "ISO date the caller's approved KYC expires, or null (rejected/pending, or approved-and-grandfathered with no expiry)." },
            },
          },
        },
      },
  ...
  submitKyc: {
    ...
    response: {
      200: { type: "object", additionalProperties: true, properties: { id: { type: "string" }, kycStatus: { type: "string" } } },
      ...errs(400, 401, 403),
    },
  },
  proposeKycDecision: {
