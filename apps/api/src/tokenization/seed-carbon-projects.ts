 ...
 *
 * Run against a live API:  API=http://localhost:4000 tsx src/tokenization/seed-carbon-projects.ts
 * Optionally set CHAIN=besu to tokenize on the live EVM (default: fabric, simulated).
 */
