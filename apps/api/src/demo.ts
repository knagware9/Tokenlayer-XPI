...
async function main(): Promise<void> {
  ...
  const app = await buildApp({ useCases, rbac, engine, users, assets, audit, accounts, chains, cash, listings, financing, deepTierCapPct: 80, currencies: loadCurrencies(), jwtSecret: "demo" });
